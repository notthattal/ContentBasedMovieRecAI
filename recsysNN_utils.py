...
def print_pred_movies(y_p, item, movie_dict, maxcount=10):
    ...
    count = 0
    disp = [["pred", "movie id", "rating ave", "title", "genres"]]
...
def print_existing_user(y_p, y, user, items, ivs, uvs, movie_dict, maxcount=10):
    ...
    """
    count = 0
    disp = [["pred", "actual rating", "genre ave for this user", "movie rating ave", "movie id", "title", "genres"]]
    count = 0
    ...
    table = tabulate.tabulate(disp, tablefmt='grid', headers="firstrow", floatfmt=[".1f", ".1f", ".0f", ".2f", ".1f"])
    print(table + "\n\n\n\n\n")
